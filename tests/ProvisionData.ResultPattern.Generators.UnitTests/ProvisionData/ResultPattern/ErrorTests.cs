    ...
    : ResultPatternUnitTestBase(fixture, output)
{
    ...
    {
        var error = new CustomError("There is no resource at this location");
        ...
        codeName.Should().Be("CustomError");
    ...
    {
        var error = new CustomError("User not found");

        error.Should().BeOfType<CustomError>();
    ...
    {
        var error1 = new CustomError("Description 1");
        var error2 = new CustomError("Description 2");
    ...
    {
        var error1 = new CustomError("Invalid input");
        var error2 = new CustomError("Invalid input");
    ...
    {
        var error = new CustomError("Invalid input");
        var sameError = error;
    ...
    {
        var error1 = new CustomError("Invalid input");
        var error2 = new CustomError("Different description");
    ...
    public void Errors_WithDifferentTypes_ShouldNotBeEqual()
    {
        ...
        var error2 = new CustomError("Description");
    ...
    public void IsErrorType_WithMatchingType_ShouldReturnTrue()
    {
        ...
        var result = error.IsErrorType<CustomError>();
