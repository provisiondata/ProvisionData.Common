...
/// </summary>
/// <param name="Code">A code identifying the error. Must not be null or empty.</param>
/// <param name="Description">A human-readable description of the error. Must not be null or empty.</param>
