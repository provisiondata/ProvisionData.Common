...
public static class SupplierExtensions
{
    ...
    public static async Task<IReadOnlyList<CompanyDto>> ListSuppliersAsync(this HaloPsaApiClient haloApiClient, CancellationToken cancellationToken = default)
    {
        var uri = "Supplier"
    ...
    public static async Task<SupplierDto> CreateSupplierAsync(this HaloPsaApiClient haloApiClient, SupplierDto supplier, CancellationToken cancellationToken = default)
    {
