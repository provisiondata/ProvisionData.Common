...
/// <summary>
/// Provides extension methods for managing recurring invoices using the HaloPSA API.
/// </summary>
public static class RecurringInvoiceExtensions
{
    ...
    public static async Task<IReadOnlyCollection<InvoiceHeaderDto>> ListRecurringInvoicesAsync(this HaloPsaApiClient haloApiClient, CancellationToken cancellationToken = default)
    {
        ...
        var result = await haloApiClient.HttpGetAsync(uri, InvoiceJsonContext.Default.ListInvoiceHeaderDto, cancellationToken);
    ...
    public static async Task<InvoiceHeaderDto> GetRecurringInvoiceAsync(this HaloPsaApiClient haloApiClient, Int32 recurringinvoiceId, CancellationToken cancellationToken = default)
    {
        var uri = "RecurringInvoice"
            .AppendPathSegment(recurringinvoiceId)
            .ToUri();
        var result = await haloApiClient.HttpGetAsync(uri, InvoiceJsonContext.Default.InvoiceHeaderDto, cancellationToken);
    ...
    public static async Task<InvoiceHeaderDto> CreateRecurringInvoiceAsync(this HaloPsaApiClient haloApiClient, InvoiceHeaderDto request, CancellationToken cancellationToken = default)
    {
        var uri = new Uri("RecurringInvoice");

        var payload = JsonSerializer.Serialize(request, InvoiceJsonContext.Default.InvoiceHeaderDto);

        var result = await haloApiClient.HttpPostAsync(uri, $"[{payload}]", InvoiceJsonContext.Default.InvoiceHeaderDto, cancellationToken);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    public static async Task CreateRecurringInvoiceScheduleAsync(this HaloPsaApiClient haloApiClient, InvoiceHeaderDto invoice, CancellationToken cancellationToken = default)
    {
