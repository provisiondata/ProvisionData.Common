...
public static class CustomerExtensions
{
    ...
    public static async Task<CustomerListDto?> ListCustomersAsync(this HaloPsaApiClient haloApiClient, CancellationToken cancellationToken = default)
    {
        var uri = "Client"
    ...
    public static async Task<CustomerDto> GetCustomerAsync(this HaloPsaApiClient haloApiClient, Int32 customerId, Boolean includeDetails = false, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<CustomerDto?> GetCustomerAsync(this HaloPsaApiClient haloApiClient, String name, CancellationToken cancellationToken = default)
    {
