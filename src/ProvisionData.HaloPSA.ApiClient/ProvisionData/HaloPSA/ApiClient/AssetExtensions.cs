...
public static partial class AssetExtensions
{
    ...
    public static async Task<IReadOnlyCollection<AssetDto>?> ListAssetsAsync(this HaloPsaApiClient haloApiClient, CancellationToken cancellationToken = default)
    {
        var uri = "Asset"
    ...
    public static async Task<AssetDto> GetAssetAsync(this HaloPsaApiClient haloApiClient, Int32 assetId, CancellationToken cancellationToken = default)
    {
        var uri = "Asset"
    ...
    public static async Task<AssetDto> CreateAssetAsync(this HaloPsaApiClient haloApiClient, AssetDto asset, CancellationToken cancellationToken = default)
    {
