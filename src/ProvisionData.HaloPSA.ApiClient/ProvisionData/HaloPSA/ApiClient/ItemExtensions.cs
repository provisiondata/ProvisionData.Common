...
public static class ItemExtensions
{
    ...
    public static async Task<IReadOnlyCollection<ItemDto>> ListItemsAsync(this HaloPsaApiClient haloApiClient, CancellationToken cancellationToken = default)
    {
        var uri = "Item"
    ...
    public static async Task<ItemDto> GetItemAsync(this HaloPsaApiClient haloApiClient, Int32 itemId, CancellationToken cancellationToken = default)
    {
        var uri = "Item"
    ...
    public static async Task<ItemDto> CreateItemAsync(this HaloPsaApiClient haloApiClient, ItemDto item, CancellationToken cancellationToken = default)
    {
